...
<link rel="stylesheet" href={{asset('css/Contact.css')}} media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header" id="sec-11b4"><div class="u-align-left u-clearfix u-sheet u-sheet-1">
    ...
    <section class="u-clearfix u-grey-5 u-section-1" id="sec-a6d6">
      <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
          <form action="https://nicepage.com/editor/Forms/Process" method="POST" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" style="padding: 10px" source="email" name="form" abineguid="67CFAFF2C10649B798AC71853E5CE270">
            <input type="hidden" id="siteId" name="siteId" value="284254">
            <input type="hidden" id="pageId" name="pageId" value="284257">
            <div class="u-form-group u-form-name">
              <label for="name-5572" class="u-form-control-hidden u-label">Nom</label>
              <input type="text" placeholder="" id="name-5572" name="name" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
            </div>
            <div class="u-form-email u-form-group">
              <label for="email-5572" class="u-form-control-hidden u-label">Email</label>
              <input type="email" placeholder="Entrez une adresse mail valide" id="email-5572" name="email" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="">
              <div id="pwm-inline-icon-74758" class="pwm-field-icon" style="margin-top: -32px; margin-left: 528px; position: absolute !important; width: 18px; height: 18px; min-height: 0px; min-width: 0px; z-index: 2147483645 !important; box-shadow: none !important; box-sizing: content-box !important; background: none !important; border: none !important; padding: 0px; cursor: pointer !important; outline: none !important;">
                <svg style="display: inline-block !important; width: 16px; height: 16px; fill: rgb(230, 0, 23) !important; margin-top: 1px; position: absolute !important; top: 0px; left: 0px;" viewBox="0 0 40 64"><g><path d="m20,28.12a33.78,33.78 0 0 1 13.36,2.74a22.18,22.18 0 0 1 0.64,5.32c0,9.43 -5.66,17.81 -14,20.94c-8.34,-3.13 -14,-11.51 -14,-20.94a22.2,22.2 0 0 1 0.64,-5.32a33.78,33.78 0 0 1 13.36,-2.74m0,-28.12c-8.82,0 -14,7.36 -14,16.41l0,5.16c2,-1.2 2,-1.49 5,-2.08l0,-3.08c0,-6.21 2.9,-11.41 8.81,-11.41l0.19,0c6.6,0 9,4.77 9,11.41l0,3.08c3,0.58 3,0.88 5,2.08l0,-5.16c0,-9 -5.18,-16.41 -14,-16.41l0,0zm0,22c-6.39,0 -12.77,0.67 -18.47,4a31.6,31.6 0 0 0 -1.53,9.74c0,13.64 8.52,25 20,28.26c11.48,-3.27 20,-14.63 20,-28.26a31.66,31.66 0 0 0 -1.54,-9.77c-5.69,-3.3 -12.08,-4 -18.47,-4l0,0l0.01,0.03z"></path><path d="m21.23,39.5a2.81,2.81 0 0 0 1.77,-2.59a2.94,2.94 0 0 0 -3,-2.93a3,3 0 0 0 -3,3a2.66,2.66 0 0 0 1.77,2.48l-1.77,4.54l6,0l-1.77,-4.5z"></path>
</g></svg>
              </div>
            </div>
            <div class="u-form-group u-form-message">
              <label for="message-5572" class="u-form-control-hidden u-label">Message</label>
              <textarea placeholder="Entrez votre message" rows="4" cols="50" id="message-5572" name="message" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""></textarea>
            </div>
